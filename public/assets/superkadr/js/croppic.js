	...
	Croppic.prototype = {
		...
		loadExistingImage: function(){
			...
			if( $.isEmptyObject(that.croppedImg)){
				...
				var img =$('<img class="img" src="'+ that.options.loadPicture +'">');
				that.obj.append(img);
				img.load(function() {
		...
		afterUpload: function(data){
            ...
            if (response.status == 'success') {
                ...
                var img = $('<img class="img" src="'+response.url+'">')
		...
		afterCrop: function (data) {
            ...
            if (response.status == 'success') {
                ...
                that.obj.append('<div class="img"><img class="croppedImg" src="' + response.url + '"></div>');
